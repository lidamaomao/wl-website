...
const About = () => {
  return (
    <div className="bg-white py-6">
      <div className="text-center md:px-[15rem] px-2">
        <h2 className="text-xl md:text-4xl">Future Expansion</h2>
      ...
      <ul className="flex flex-wrap justify-around mt-4 w-full md:px-[4rem]">
        {aboutUs.map((item) => {
          return (
            <li
              className="p-6 md:pt-10 text-center text-[#717CFF] md:w-[23rem] md:h-[25rem] md:text-start md:shadow-xl mb-6 md:hover:scale-[110%]"
              key={item.icon}
            >
              <AboutItem {...item} />
            </li>
